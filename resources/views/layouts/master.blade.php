...
@if(Auth::check())
                    ...
                    <li><a href="{{ route('User.index') }}"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;Akun</a></li>
                    <li><a href="{{ route('Tipe.index') }}"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;Tipe mobil</a></li>
                    <li><a href="{{ route('Merekk.index') }}"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;Merek mobil</a></li>
                    <li><a href="{{ route('Pemasang.index') }}"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;Pemasang iklan</a></li>
                    <li><a href="{{ route('Foto.index') }}"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;Foto Mobil</a></li>
                    <li><a href="{{ route('Iklan.index') }}"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;Iklan</a></li>
